...
if (!window.owfJsPath) {
    ...
    window.owfJsPath = (function() {
        var path = window.contextPath + __VENDOR_PATH +"js/";
...
if (!window.esriJsPath) {
    ...
    window.esriJsPath = (function() {
        ...
        if (window.isOffline()) {
            ...
            path = window.contextPath + __VENDOR_PATH+"js/esri/";
...
dojoConfig.packages = [
    ...
    { location: window.contextPath + __VENDOR_PATH+"js", name: "notify" },
    { location: window.contextPath + "js/custom", name:"custom" }
];
