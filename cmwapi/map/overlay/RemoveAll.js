define(["cmwapi/Channels", "cmwapi/Validator"], function(Channels, Validator) {
     ...
     * @version 1.1
     *
     * @exports cmwapi/map/overlay/RemoveAll
     */
    var Remove = {
         ...
         */
        send: function() {
        	//Just needs a boolean to determine whether it will send the data or not
            OWF.Eventing.publish(Channels.MAP_OVERLAY_REMOVE_ALL);
        },
        ...
        addHandler: function(handler) {
            ...
            OWF.Eventing.subscribe(Channels.MAP_OVERLAY_REMOVE_ALL, newHandler);
            return newHandler;
        },
        ...
        removeHandlers: function() {
            OWF.Eventing.unsubscribe(Channels.MAP_OVERLAY_REMOVE_ALL);
        }
